...
if (isset($_GET["page"])){
    ...
    if ($_GET["page"] == "" && $_POST) {
        ...
        function grab_image ($url, $setup)
        {
            ...
            $path = "./tmp/" . $filecount . "." . pathinfo($filename[0], PATHINFO_EXTENSION);
            $remotedir = "./tmp/test/";
            $remotepath = $remotedir . $filecount . "." . pathinfo($filename[0], PATHINFO_EXTENSION);

            if (pathinfo($filename[0], PATHINFO_EXTENSION) == "js"){
                return false;
            }
